...
// User routes
Route::post('users/restore/{id}', [UserController::class, 'restore'])->middleware(['auth:sanctum', 'role:admin']);
...
// Product routes
Route::post('/products/restore/{id}', [ProductController::class, 'restore'])->middleware(['auth:sanctum', 'role:admin']);
