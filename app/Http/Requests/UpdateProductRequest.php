    ...
    public function getValidationRules(string $category)
    {
        ...
        $categorySpecificRules = [
            ...
            'cpu' => [
                ...
                'base_clock' => 'required|integer|min:800|max:8000',
                'boost_clock' => 'required|integer|min:800|max:8000',
                'consumption' => 'required|integer|min:5|max:500',
            ...
            'motherboard' => [
                ...
                'memory_type' => 'required|string|in:DDR3,DDR4,DDR5',
                'memory_speed' => 'required|integer|in:1066,1333,1600,1866,2133,2400,2666,3000,3200,3600,4800,5200,5600,6000,6400,7200',
            ...
            'psu' => [
                'efficiency_rating' => 'required|string|in:80+ Bronze,80+ Silver,80+ Gold,80+ Platinum',
            ...
            'case' => [
                ...
                'expansion_slots' => 'required|integer|min:0|max:9',
                'max_gpu_length' => 'required|numeric|min:260|max:420',
                'max_cpu_cooler_height' => 'required|numeric|min:145|max:180',
                'radiator_support' => 'required|boolean',
                'extra_fans_connectors' => 'required|integer|min:2|max:10',
                'depth' => 'required|numeric|min:150|max:300',
                'width' => 'required|numeric|min:300|max:800',
                'height' => 'required|numeric|min:300|max:800',
                'weight' => 'required|numeric|min:2|max:20',
            ],
            'cooler' => [
                'type' => 'required|string|in:Air,Liquid',
                'fan_rpm' => 'required|integer|min:1000|max:3000',
                'consumption' => 'required|integer|min:5|max:50',
                'socket_support' => 'required|string|in:LGA1151,LGA1200,AM4,LGA1700,AM5,SP3,SP5,LGA2066',
                'width' => 'required|numeric|min:100|max:300',
            ...
            'keyboard' => [
                ...
                'width' => 'required|numeric|min:250|max:450',
                'height' => 'required|numeric|min:30|max:60',
                'weight' => 'required|numeric|min:600|max:4000',
            ],
            'mouse' => [
                'dpi' => 'required|integer|min:600|max:20000',
                'sensor' => 'required|string|in:Optical,Laser',
                'buttons' => 'required|integer|min:2|max:20',
                'bluetooth' => 'required|boolean',
                'weight' => 'required|numeric|min:50|max:150',
            ],
            'storage' => [
                'type' => 'required|string|in:SSD,HDD,NVMe,NVMe M.2',
                'capacity' => 'required|integer|in:120,250,500,1000,2000,4000',
                'rpm' => 'nullable|integer|min:0|max:7200',
                'read_speed' => 'required|integer|min:100|max:14000',
                'write_speed' => 'required|integer|min:100|max:12000',
            ],
        ];
